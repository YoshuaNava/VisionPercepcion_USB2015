...
if(NOT "include;/usr/include/opencv;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(usbgm_pfs_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/opencv;/usr/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'usbgm_pfs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alfredoso/GitHub/VisionPercepcion_USB2015/Code/Thesis_ws/install/${idir}'.  Ask the maintainer 'Rafael Colmenares <rafaelcolmenaresusb@gmail.com>' to fix it.")
    endif()
