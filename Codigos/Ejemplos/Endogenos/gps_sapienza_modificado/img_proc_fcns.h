...
//EDGE
//void Sobel(IplImage* gray, IplImage* sob, IplImage* sob_prob,  CvRect Safe);
//COLOUR
...
//void ProbAnalysis(IplImage* bin_img, IplImage* prior, IplImage* prob_result_img, IplImage* sobel_prob_img, IplImage* col_prob_img, IplImage* lbp_prob_img);
//void ProbSuperPixelClassification(IplImage* gbs_img, Statistics *sts, IplImage* prob_result_img, IplImage* bin_img);

//int* LBP8(const int * data, int rows, int columns);
//void LBPAnalysis2(IplImage* LBP, IplImage* LBP_CUE, IplImage* LBP_PROB, Model* M, Statistics *sts, IplImage *gbs);
//void ColorHistAnalysis2(IplImage*src, IplImage* hsv, IplImage* col_cue, IplImage* col_prob, Model* M, Statistics *sts, IplImage *gbs);
//void EdgeAnalysis(IplImage* ang, IplImage* sob_prob, Model* M, statistics* S, IplImage* gbs_img);
//int sq(int a, int b);
...
//void DrawWatershedContours(IplImage* output, IplImage* marker); //Draw contours
//void DrawWatershed(IplImage* output, IplImage* src, CvMat* color_tab);

//void Canny(IplImage* gray, IplImage* binary);
//void TemplateMatching(IplImage* src, IplImage* result, CvPoint pt, int METHOD);
//void PyrMeanShiftFiltering(IplImage* source, IplImage* MSS);
